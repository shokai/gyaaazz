...
function save_page(){
    ...
    timer_save = setTimeout(function(){
	    ...
	    var tmp = data;
	    $.post(location.href+'.json', tmp, function(res){
...
function markup(line){
    ...
    line = line.replace_all(/\[\[\[(https?\:[\w\.\~\-\/\?\&\+\=\:\@\%\;\#\%]+) (https?\:[\w\.\~\-\/\?\&\+\=\:\@\%\;\#\%]+)(.jpe?g|.gif|.png)\]\]\]/, '<a href="$1"><img src="$2$3" class="thumb" /></a>', ']]]');
    line = line.replace_all(/\[\[\[(https?\:[\w\.\~\-\/\?\&\+\=\:\@\%\;\#\%]+)(.jpe?g|.gif|.png)\]\]\]/, '<a href="$1"><img src="$1$2" class="thumb" /></a>', ']]]');
